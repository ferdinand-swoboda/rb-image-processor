...
public class WorksToHTMLTextsTransformationTest {
    ...
    public void transformationShouldProduceCorrectIndexHTMLText() throws IOException {
        ...
        try(FileInputStream inputStream = new FileInputStream(getClass().getResource("index.html").getFile())) {
    ...
    private List<Work> createWorks() {
        ...
        works.add(new Work(31820, Arrays.asList("http://ih1.redbubble.net/work.31820.1.flat,135x135,075,f.jpg", "http://ih1.redbubble.net/work.31820.1.flat,300x300,075,f.jpg", "http://ih1.redbubble.net/work.31820.1.flat,550x550,075,f.jpg"), "NIKON D80", "NIKON CORPORATION"));

        works.add(new Work(867035, Arrays.asList("http://ih1.redbubble.net/work.867035.1.flat,135x135,075,f.jpg", "http://ih1.redbubble.net/work.867035.1.flat,300x300,075,f.jpg", "http://ih1.redbubble.net/work.867035.1.flat,550x550,075,f.jpg"), null, null));

        works.add(new Work(2041, Arrays.asList("http://ih1.redbubble.net/work.2041.1.flat,135x135,075,f.jpg", "http://ih1.redbubble.net/work.2041.1.flat,300x300,075,f.jpg", "http://ih1.redbubble.net/work.2041.1.flat,550x550,075,f.jpg"), "Canon EOS 20D", "Canon"));
